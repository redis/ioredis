...
interface RedisCommander<Context extends ClientContext = { type: "default" }> {
   ...
   */
  cluster(...args: [subcommand: 'DELSLOTSRANGE', ...startSlotEndSlots: (number)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'DELSLOTSRANGE', ...startSlotEndSlots: (number)[]]): Result<unknown, Context>;
   ...
   * - _complexity_: O(N) where N is the total number of the slots between the start slot and end slot arguments.
   */
  cluster(...args: [subcommand: 'ADDSLOTSRANGE', ...startSlotEndSlots: (number)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'ADDSLOTSRANGE', ...startSlotEndSlots: (number)[]]): Result<unknown, Context>;
