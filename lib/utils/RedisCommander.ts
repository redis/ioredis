...
interface RedisCommander<Context extends ClientContext = { type: "default" }> {
   ...
   * - _since_: 1.2.0
   */
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: 'LIMIT', offset: number | string, count: number | string, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>>): Result<RespShape<Resp2<string[]>, Resp3<[member: string, score: Resp3Double<string>][]>, Context>, Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, withscores: 'WITHSCORES', callback?: Callback<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>>): Result<RespShape<Resp2<Buffer[]>, Resp3<[member: Buffer, score: Resp3Double<Buffer>][]>, Context>, Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: 'LIMIT', offset: number | string, count: number | string, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: 'BYSCORE', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: 'BYLEX', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
