...
interface RedisCommander<Context extends ClientContext = { type: "default" }> {
   ...
   */
  acl(subcommand: 'LOAD', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(N). Where N is the number of configured users.
   */
  acl(subcommand: 'USERS', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(N). Where N is the number of configured users.
   */
  acl(subcommand: 'LIST', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(N). Where N is the number of configured users.
   */
  acl(subcommand: 'SAVE', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  acl(subcommand: 'GENPASS', callback?: Callback<unknown>): Result<unknown, Context>;
  acl(subcommand: 'GENPASS', bits: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  acl(subcommand: 'WHOAMI', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1).
   */
  acl(subcommand: 'DRYRUN', username: string | Buffer, command: string | Buffer, callback?: Callback<unknown>): Result<unknown, Context>;
  acl(...args: [subcommand: 'DRYRUN', username: string | Buffer, command: string | Buffer, ...args: (string | Buffer | number)[], callback: Callback<unknown>]): Result<unknown, Context>;
  acl(...args: [subcommand: 'DRYRUN', username: string | Buffer, command: string | Buffer, ...args: (string | Buffer | number)[]]): Result<unknown, Context>;
   ...
   */
  acl(...args: [subcommand: 'DELUSER', ...usernames: (string | Buffer)[], callback: Callback<unknown>]): Result<unknown, Context>;
  acl(...args: [subcommand: 'DELUSER', ...usernames: (string | Buffer)[]]): Result<unknown, Context>;
   ...
   */
  acl(subcommand: 'SETUSER', username: string | Buffer, callback?: Callback<unknown>): Result<unknown, Context>;
  acl(...args: [subcommand: 'SETUSER', username: string | Buffer, ...rules: (string | Buffer)[], callback: Callback<unknown>]): Result<unknown, Context>;
  acl(...args: [subcommand: 'SETUSER', username: string | Buffer, ...rules: (string | Buffer)[]]): Result<unknown, Context>;
   ...
   */
  acl(subcommand: 'GETUSER', username: string | Buffer, callback?: Callback<unknown>): Result<unknown, Context>;
  ...
  bitcount(key: RedisKey, start: number, end: number | string, callback?: Callback<number>): Result<number, Context>;
  bitcount(key: RedisKey, start: number, end: number | string, byte: 'BYTE', callback?: Callback<number>): Result<number, Context>;
  bitcount(key: RedisKey, start: number, end: number | string, bit: 'BIT', callback?: Callback<number>): Result<number, Context>;
  ...
  bitpos(key: RedisKey, bit: number | string, start: number, end: number | string, callback?: Callback<number>): Result<number, Context>;
  bitpos(key: RedisKey, bit: number | string, start: number, end: number | string, byte: 'BYTE', callback?: Callback<number>): Result<number, Context>;
  bitpos(key: RedisKey, bit: number | string, start: number, end: number | string, bit1: 'BIT', callback?: Callback<number>): Result<number, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'INFO', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'SETNAME', connectionName: string | Buffer, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'GETNAME', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'PAUSE', timeout: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
  client(subcommand: 'PAUSE', timeout: number | string, write: 'WRITE', callback?: Callback<unknown>): Result<unknown, Context>;
  client(subcommand: 'PAUSE', timeout: number | string, all: 'ALL', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'ID', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'GETREDIR', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'TRACKINGINFO', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  client(subcommand: 'CACHING', yes: 'YES', callback?: Callback<unknown>): Result<unknown, Context>;
  client(subcommand: 'CACHING', no: 'NO', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  client(subcommand: 'UNPAUSE', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'MEET', ip: string | Buffer, port: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(subcommand: 'COUNT-FAILURE-REPORTS', nodeId: string | Buffer | number, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(...args: [subcommand: 'DELSLOTSRANGE', ...startSlotEndSlots: (string | number)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'DELSLOTSRANGE', ...startSlotEndSlots: (string | number)[]]): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'REPLICATE', nodeId: string | Buffer | number, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'SAVECONFIG', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(subcommand: 'GETKEYSINSLOT', slot: number | string, count: number, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'COUNTKEYSINSLOT', slot: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'FAILOVER', callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'FAILOVER', force: 'FORCE', callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'FAILOVER', takeover: 'TAKEOVER', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(...args: [subcommand: 'ADDSLOTS', ...slots: (number | string)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'ADDSLOTS', slots: (number | string)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'ADDSLOTS', ...slots: (number | string)[]]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'ADDSLOTS', slots: (number | string)[]]): Result<unknown, Context>;
   ...
   * - _complexity_: O(N) where N is the total number of the slots between the start slot and end slot arguments.
   */
  cluster(...args: [subcommand: 'ADDSLOTSRANGE', ...startSlotEndSlots: (string | number)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'ADDSLOTSRANGE', ...startSlotEndSlots: (string | number)[]]): Result<unknown, Context>;
   ...
   * - _complexity_: O(N) where N is the total number of Cluster nodes
   */
  cluster(subcommand: 'SLOTS', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(subcommand: 'KEYSLOT', key: string | Buffer, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'SET-CONFIG-EPOCH', configEpoch: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  cluster(subcommand: 'RESET', callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'RESET', hard: 'HARD', callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'RESET', soft: 'SOFT', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'INFO', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'MYID', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'FLUSHSLOTS', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'FORGET', nodeId: string | Buffer | number, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(N) where N is the total number of hash slot arguments
   */
  cluster(...args: [subcommand: 'DELSLOTS', ...slots: (number | string)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'DELSLOTS', slots: (number | string)[], callback: Callback<unknown>]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'DELSLOTS', ...slots: (number | string)[]]): Result<unknown, Context>;
  cluster(...args: [subcommand: 'DELSLOTS', slots: (number | string)[]]): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'BUMPEPOCH', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(1)
   */
  cluster(subcommand: 'SETSLOT', slot: number | string, nodeIdToken: 'IMPORTING', nodeId: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'SETSLOT', slot: number | string, nodeIdToken: 'MIGRATING', nodeId: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'SETSLOT', slot: number | string, nodeIdToken: 'NODE', nodeId: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
  cluster(subcommand: 'SETSLOT', slot: number | string, stable: 'STABLE', callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   */
  exec(callback?: Callback<[error: Error, result: unknown][] | null>): Result<[error: Error, result: unknown][] | null, Context>;
  execBuffer(callback?: Callback<[error: Error, result: unknown][] | null>): Result<[error: Error, result: unknown][] | null, Context>;
   ...
   */
  getrange(key: RedisKey, start: number, end: number | string, callback?: Callback<string>): Result<string, Context>;
  getrangeBuffer(key: RedisKey, start: number, end: number | string, callback?: Callback<Buffer>): Result<Buffer, Context>;
   ...
   */
  hgetall(key: RedisKey, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(N) where N is the length of the returned string. The complexity is ultimately determined by the returned length, but because creating a substring from an existing string is very cheap, it can be considered O(1) for small strings.
   */
  substr(key: RedisKey, start: number, end: number | string, callback?: Callback<unknown>): Result<unknown, Context>;
   ...
   * - _complexity_: O(log(N)) with N being the number of elements in the sorted set.
   */
  zlexcount(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<number>): Result<number, Context>;
   ...
   */
  zmscore(...args: [key: RedisKey, ...members: (string | Buffer | number)[], callback: Callback<unknown[] | null>]): Result<unknown[] | null, Context>;
  zmscore(...args: [key: RedisKey, members: (string | Buffer | number)[], callback: Callback<unknown[] | null>]): Result<unknown[] | null, Context>;
  zmscore(...args: [key: RedisKey, ...members: (string | Buffer | number)[]]): Result<unknown[] | null, Context>;
  zmscore(...args: [key: RedisKey, members: (string | Buffer | number)[]]): Result<unknown[] | null, Context>;
   ...
   */
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrange(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<string[]>): Result<string[], Context>;
  zrangeBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, withscores: 'WITHSCORES', callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
   ...
   */
  zrangebylex(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<string[]>): Result<string[], Context>;
  zrangebylexBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrangebylex(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrangebylexBuffer(key: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
   ...
   */
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, byscore: 'BYSCORE', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', callback?: Callback<number>): Result<number, Context>;
  zrangestore(dst: RedisKey, src: RedisKey, min: string | Buffer, max: string | Buffer, bylex: 'BYLEX', rev: 'REV', offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<number>): Result<number, Context>;
   ...
   */
  zremrangebylex(key: RedisKey, min: string | Buffer, max: string | Buffer, callback?: Callback<number>): Result<number, Context>;
   ...
   * - _complexity_: O(log(N)+M) with N being the number of elements in the sorted set and M the number of elements being returned. If M is constant (e.g. always asking for the first 10 elements with LIMIT), you can consider it O(log(N)).
   */
  zrevrangebylex(key: RedisKey, max: string | Buffer, min: string | Buffer, callback?: Callback<string[]>): Result<string[], Context>;
  zrevrangebylexBuffer(key: RedisKey, max: string | Buffer, min: string | Buffer, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
  zrevrangebylex(key: RedisKey, max: string | Buffer, min: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<string[]>): Result<string[], Context>;
  zrevrangebylexBuffer(key: RedisKey, max: string | Buffer, min: string | Buffer, offsetCountToken: 'LIMIT', offset: number | string, count: number, callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
   ...
   */
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[]]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[]]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, keys: (RedisKey)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[]]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', sum: 'SUM', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', sum: 'SUM']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', sum: 'SUM', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', min: 'MIN', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', min: 'MIN']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', min: 'MIN', withscores: 'WITHSCORES']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', max: 'MAX', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', max: 'MAX']): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES', callback: Callback<unknown[]>]): Result<unknown[], Context>;
  zunion(...args: [numkeys: number | string, ...args: (RedisValue)[], aggregate: 'AGGREGATE', max: 'MAX', withscores: 'WITHSCORES']): Result<unknown[], Context>;
