...
/**
 * Convert an object to an inverted array
 *
 * @param {object} obj
 * @return {array}
 * @example
 * ```js
 * > convertObjectToInvertArray({ a: '1' })
 * ['1', 'a']
 * ```
 */
exports.convertObjectToInvertArray = function (obj) {
  var result = [];
  for (var key in obj) {
...
/**
 * Convert a map to an inverted array
 *
 * @param {Map} map
 * @return {array}
 * @example
 * ```js
 * > convertMapToInvertArray(new Map([[1, '2']]))
 * ['2', 1]
 * ```
 */
exports.convertMapToInvertArray = function (map) {
  var result = [];
  var pos = 0;
  map.forEach(function (value, key) {
    result[pos] = value;
