 ...
 * @param {number} [options.refreshSlotsTimeout=1000] - The milliseconds before a timeout occurs while refreshing
...
Cluster.prototype.getInfoFromNode = function (redis, callback) {
  ...
  redis.cluster('slots', utils.timeout(function (err, result) {
    ...
    callback();
  }, this.options.refreshSlotsTimeout));
};
