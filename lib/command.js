...
function Command(name, args, options, callback) {
  ...
  this.preArgs = options.preArgs | 0;
...
Command.prototype.initPromise = function () {
  ...
  this.promise = new Promise(function (resolve, reject) {
    if (!_this.transformed) {
      ...
      var transformer = Command._transformer.argument[_this.command];
      if (transformer) {
        if(_this.preArgs) {
          _this.args = _this.args.slice(0, _this.preArgs).concat(transformer(_this.args.slice(_this.preArgs)));
        } else {
          _this.args = transformer(_this.args);
        }
      }
      if (_this.keyPrefix) {
        _this._iterateKeys(function (key) {
          return _this.keyPrefix + key;
        });
      }
...
Command.prototype._convertValue = function (resolve) {
  ...
  return function (value) {
    ...
    try {
      ...
      transformer = Command._transformer.reply[_this.command];
      if (transformer) {
